...
<body>
	...
	<section class="container">
		...
		<form:form  modelAttribute="businessOwner" action = "addBusinessOwner" method = "post" class="form-horizontal">
			<fieldset>
				<legend><spring:message code="addBusinessOwner.form.business.formInfo"/></legend>

				<form:errors path="*" cssClass="alert alert-danger" element="div"/>				
				
						<!-- Hidden  Filed used in case of updating-->				
					<form:input id="business.name" path="OwnerId" type="hidden" class="form:input-large"/>
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for="business.type"><spring:message code="addBusinessClient.form.business.type.label"/></label>
					<div class="col-lg-10">
						<form:input id="business.type" path="business.type" type="text" class="form:input-large"/>
						<form:errors path="business.type" cssClass="text-danger"/>
					</div>
				</div>
				...
				<fieldset>
				<legend><spring:message code="addBusinessOwner.form.business.contact.phone.label"/></legend>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<spring:url value="/listPersonOwners" var="cancel_url" ></spring:url>
