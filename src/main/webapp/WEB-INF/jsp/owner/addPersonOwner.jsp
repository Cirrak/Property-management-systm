...
<body>
	...
	<div id = "ownerPersonForm">
		<form:form  modelAttribute="personOwner" action = "addPersonOwner" method = "post" class="form-horizontal">
			<fieldset>
				<legend><spring:message code="addPersonOwner.form.person.formInfo"/></legend>

				<form:errors path="*" cssClass="alert alert-danger" element="div"/>
				
				<!-- Hidden  field-->				
					<form:input id="person.firstName" path="ownerId" type="hidden" class="form:input-large"/>
				...
				<fieldset>
				<legend><spring:message code="addPersonOwner.form.person.contact.phone.label"/></legend>
				<div class="form-group">
