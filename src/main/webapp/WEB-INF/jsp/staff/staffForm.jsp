		...
		<form:form  modelAttribute="staff" action = "addStaff" class="form-horizontal" method = "post">
			<fieldset>
				...
				<!-- Hidden  Filed used in case of updating-->				
					<form:input id="staffId" path="staffId" type="hidden" class="form:input-large"/>
					<form:input id="personId" path="person.personId" type="hidden" class="form:input-large"/>
					<form:input id="contactId" path="person.contact.contactId" type="hidden" class="form:input-large"/>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input id="person.birthDate" path="person.birthDate" type="text" placeholder = "DD/MM/YYYY" class="form:input-large"/>
				...
				<div class="form-group">
					<div class="col-lg-offset-2 col-lg-10">
						<input type="submit" id="btnAdd" class="btn btn-primary" value = "<spring:message code="form.button.value"/>"/>
						           <spring:url value="/staffList" var="cancel_url" ></spring:url>
