	...
	<section>
		<div class="jumbotron">
  			<div class="pull-right" style="padding-right:50px">
				<a href="?lang=en" >English</a>|<a href="?lang=fr_CA" >French</a>					
			</div>
		...
		<form:form  modelAttribute="building" class="form-horizontal" action="register" method="post"  enctype="multipart/form-data">
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:radiobutton path="status" value="ocuupied" />Occupied 
					...
					<div class="col-lg-10">
            <form:input id="photo" path="photo" type="file" required="required"/> 
					</div>
				</div>
				...
				<div class="form-group">
					...
					<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
						<input type="submit" id="btnAdd" class="btn btn-primary" value ="Add"/>
							 <spring:url value="/" var="cancel_url" ></spring:url>
