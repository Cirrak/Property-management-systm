...
function showDetails(staffId){
   	...
   	//var dataToSend = JSON.stringify(serializeObject($('#categoryForm')));
		...
		success: function(staff){
			...
			$('#formInput').html("");
			$("#formInput").append('<H2 align="center"> Staff Information </H2>');                
			...
			$("#formInput").append('<h4 align="center"> <a href="#" onclick="toggle_visibility(\'formInput\');"><b color:Red>EXIT</b> </a> </h4>');
