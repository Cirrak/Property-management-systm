...
public class ClientController {
	...
	public @ResponseBody  PersonClient  getRestPersonClient(@RequestParam("personClientId") Long personClientId  ) {
	...
	// Used for displaying Business Clients
		...
		public String displayBusinessClientDetails() {
			return "client/businessClientDetails";
		}
		
		
		@RequestMapping(value = "/deleteBusinessClient", method = RequestMethod.GET)
		public String deleteBusinessClient(@RequestParam("businessClientId") long businessClientId, Model theModel) {
			
			// delete the customer
			businessClientService.delete(businessClientService.findOne(businessClientId));
			
			return "redirect:/listBusinessClients";
		}

		@RequestMapping(value = "/updateBusinessClient", method = RequestMethod.GET)
		public String showBusinessClientFormForUpdate(@RequestParam("businessClientId") long businessClientId , Model model) {
			model.addAttribute(businessClientService.findOne(businessClientId));
			
			return "client/addBusinessClient";
		}
		
		
		@RequestMapping(value="/showBusinessClientDetail")
		public @ResponseBody  BusinessClient  getRestBusinessClient (@RequestParam("businessClientId") Long businessClientId  ) {
			
			BusinessClient businessClient = businessClientService.findOne(businessClientId);
			System.out.println(businessClient.getBusiness().getName());
