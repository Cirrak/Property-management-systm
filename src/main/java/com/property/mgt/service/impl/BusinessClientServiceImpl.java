...
public class BusinessClientServiceImpl implements BusinessClientService {
	...
	@Override
	public BusinessClient findOne(long businessClientId) {
		
		return businessClientRepository.findOne(businessClientId);
	}

	@Override
	public void delete(BusinessClient businessClient) {
		businessClientRepository.delete(businessClient);
